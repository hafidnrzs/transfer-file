...
<body>
    ...
    <?php
        ...
        echo "<a href='addBrg.php' class='btn btn-success text-white mt-3'>Tambah Data</a>";
        if ($hasil->num_rows > 0) {
            ...
            ?>
                <tr>
                    ...
                    <td><a href='editBrg.php?id=<?= $row["id"]; ?>' class='text-decoration-none'><i class='bi bi-pencil-square'></i> Edit</a></td>
                    <td><a href='delBrg.php?id=<?= $row["id"]; ?>' class='text-decoration-none text-danger'><i class='bi bi-trash'></i> Hapus</a></td>
                </tr>
            <?php
            }
            echo "</tbody>
